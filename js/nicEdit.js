...
var nicEditorConfig = bkClass.extend({
	...
	'right': {name: __('Aligne à droite'), command: 'justifyright', noActive: true},
    ...
    buttonList: ['save', 'bold', 'italic', 'underline', 'left', 'center', 'right', 'justify', 'ol', 'ul', 'fontSize', 'fontFamily', 'fontFormat', 'indent', 'outdent', 'image', 'upload', 'link', 'unlink', 'forecolor', 'bgcolor', 'close'],
...
var nicEditor = bkClass.extend({
	...
	do {
	    ...
	    //***** version remplacement JY (sinon les .SVG qui ont des classname.baseval plantent) :
	    if (t.className) {
